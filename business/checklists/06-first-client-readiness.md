...
- [ ] Voicemail greeting says {BRAND} and asks for name, address and service (음성사서함 인사말에 {BRAND}, 이름·주소·서비스를 남겨 달라는 안내)
...
- [ ] Opt-outs honoured **within 10 business days** and logged in `business/b2b/unsubscribe-log.csv` (memo F11) (수신 거부는 **10영업일 안에** 처리하고 기록)
