...
| EN | KO |
|---|---|
| Ask in person at the end of the job, then send the link. | 작업이 끝나면 먼저 직접 부탁하고, 그다음에 링크를 보내세요. |
...
| Consent: a purchase gives 2 years of implied consent ([CASL s.10(10)](https://github.com/justicecanada/laws-lois-xml/blob/main/eng/acts/E-1.6.xml)). Keep the ID and opt-out lines anyway. | 구매 고객은 2년간 묵시적 동의가 있어요. 그래도 발신자 정보와 수신거부 문구는 꼭 넣으세요. |
...
| EN | KO |
|---|---|
| Pitch at the end of a first deep or move-in clean, in person. Use the text version only if you didn't get to ask. | 첫 대청소·입주 청소가 끝날 때 직접 제안하세요. 직접 못 물어봤을 때만 문자를 쓰세요. |
...
**Sources / 출처:** decision memo §2, §6, §7 (week 3: referral names the referrer), §10 and F11, F12, F38; `business/research/dossiers/cross_compliance.json` (SOR/2013-221 s.4(1) wording; CASL s.10(10)); `config/prices.ts`.
