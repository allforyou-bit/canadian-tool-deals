...
export const metadata: Metadata = { title: 'Door hanger', robots: { index: false, follow: false } }
...
export default async function Page({ params }: { params: Promise<{ cluster: string }> }) {
  ...
  return (
    <PrintFrame lang="en" back="/print/">
      <DoorHangerSheet lang="en" cluster={cluster as Cluster} />
    </PrintFrame>
  )
}
